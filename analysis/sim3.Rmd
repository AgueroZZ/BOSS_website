...
The above BOSS algorithm with `modal` convergence criterion converged in $65$ iterations.
...
The above BOSS algorithm with `aghq` criterion converged with $75$ iterations.
...
We first compare the marginal posterior distributions of $R$ and $\beta$ from `inlabru`, modal-based BOSS, and AGHQ-based BOSS, and MCMC.
