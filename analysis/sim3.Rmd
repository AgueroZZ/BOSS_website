...
set.seed(1234)
inla.samples.a <- a_fun(inla.rmarginal(76000, fit$marginals.fixed$a))
inla.samples.b <- b_fun(inla.rmarginal(76000, fit$marginals.fixed$b))
...
set.seed(123456)
sample_idx <- rmultinom(1:90000, size = 76000, prob = post_x_modal$pos)
...
plot(MCMC_samp[seq(1, 156000, by = 10),c('a','b')], asp = 1)
