...
Compare the above figure to the previous figure with varying $\delta$, we see that the number of iterations till convergence clearly decreases. Although the magnitude of the decrease does not seem to be significant.
