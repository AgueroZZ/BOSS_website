...
In addition, we also provide readers with some intuition in terms of the convergence performance of BOSS with respect to the dimension of the parameter space as well as hyper-parameters of the BOSS algorithm.
